 ...
 *
 *  Module: Backend Unit Test Customer Inventory State Test
 *
 *  This module defines automated backend checks for backend unit test customer inventory state test.
 *
 *  The module provides:
 *
